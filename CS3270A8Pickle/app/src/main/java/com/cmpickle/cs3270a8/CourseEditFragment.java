...
public class CourseEditFragment extends Fragment {
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
        ...
        inflater.inflate(com.cmpickle.cs3270a8.R.menu.menu_course_edit, menu);
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case com.cmpickle.cs3270a8.R.id.action_save:
                saveCourse();
                break;
    ...
    public void saveCourse() {
        ...
        fragmentManager.beginTransaction().replace(com.cmpickle.cs3270a8.R.id.fragment_container, fragmentManager.findFragmentByTag(MainActivity.COURSE_LIST_FRAGMENT)).commit();
    }
